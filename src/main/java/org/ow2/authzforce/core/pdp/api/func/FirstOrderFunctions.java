...
/**
 * Generic first-order functions, "first-order" as opposed to "higher-order". (Higher-order functions are implemented in separate classes.)
 */
public final class FirstOrderFunctions
{
	private FirstOrderFunctions()
	{
	 ...
	 */
	public static abstract class SingleParameterTypedFirstOrderFunction<RETURN_T extends Value, PARAM_T extends Value> extends FirstOrderFunction<RETURN_T>
	{
		protected FirstOrderFunctionSignatures.SingleParameterTyped<RETURN_T, PARAM_T> functionSignature;
		...
		{
			super(name);
			this.functionSignature = new FirstOrderFunctionSignatures.SingleParameterTyped<>(name, returnType, varargs, parameterTypes);
		}
	 ...
	 *            function return type
	 */
	public static abstract class MultiParameterTypedFirstOrderFunction<RETURN_T extends Value> extends FirstOrderFunction<RETURN_T>
	{
		...
		{
			super(name);
			this.functionSignature = new FirstOrderFunctionSignatures.MultiParameterTyped<>(name, returnType, varargs, parameterTypes);
		}
