...
public abstract class FirstOrderFunction<RETURN extends Value> extends BaseFunction<RETURN>
{
	...
	public static abstract class SingleParameterTyped<RETURN_T extends Value, PARAM_T extends Value> extends FirstOrderFunction<RETURN_T>
	{
		 ...
		 * 
		 */
		public SingleParameterTyped(String name, Datatype<RETURN_T> returnType, boolean varargs, List<? extends Datatype<PARAM_T>> parameterTypes) throws IllegalArgumentException
		{
			super(name);
