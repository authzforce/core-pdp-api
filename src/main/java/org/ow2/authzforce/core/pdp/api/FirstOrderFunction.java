...
public abstract class FirstOrderFunction<RETURN extends Value> extends BaseFunction<RETURN>
{
	 ...
	 *            {@link FirstOrderFunctionCall#evaluate(EvaluationContext, boolean, AttributeValue...)} at request evaluation time, via the returned
	 ...
	 */
	public abstract FirstOrderFunctionCall<RETURN> newCall(List<Expression<?>> argExpressions, Datatype<?>... remainingArgTypes)
			throws IllegalArgumentException;
