...
public interface ExpressionFactory extends Closeable
{
	 ...
	 */
	ValueExpression<? extends AttributeValue> getInstance(AttributeValueType jaxbAttrVal, XPathCompiler xPathCompiler) throws IllegalArgumentException;
	 ...
	 * 
	 */
	Function<?> getFunction(String functionId, Datatype<?> subFunctionReturnType) throws IllegalArgumentException;
}