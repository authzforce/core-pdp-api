...
public abstract class FirstOrderFunctionCall<RETURN extends Value> implements FunctionCall<RETURN>
{
	 ...
	 */
	public FirstOrderFunctionCall(FunctionSignature<RETURN> functionSig, List<Expression<?>> argExpressions, Datatype<?>... remainingArgTypes)
			throws IllegalArgumentException
	{
	 ...
	 *            {@link #FirstOrderFunctionCall(FunctionSignature, List, Datatype...)}. Null if none. Only non-bag/primitive values are valid
	 ...
	 * evaluation-time args are not supported). If some ending parameters are primitive, use {@link FirstOrderFunctionCall.EagerPartlyBagEval} instead.
	 * 
	 * @param <RETURN_T>
	 *            function return type
	 * 
