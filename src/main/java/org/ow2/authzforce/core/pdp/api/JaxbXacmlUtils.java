...
public final class JaxbXacmlUtils
{
	...
	public static final class NonIssuedLikeIssuedStrictJaxbXACMLAttributeParser implements JaxbXACMLAttributeParser<AttributeBag<?>>
	{
		 ...
		 */
		public NonIssuedLikeIssuedStrictJaxbXACMLAttributeParser(final DatatypeFactoryRegistry datatypeFactoryRegistry) throws IllegalArgumentException
		{
	...
	/**
	 * 
	 * "Lax" XACML/JAXB Attribute parser. "Lax" means it allows defining multi-valued attributes by repeating the same XACML Attribute (same AttributeId) within a XACML Attributes element (same
	 * Category) but with possibly different AttributeValues. As discussed on the xacml-dev mailing list (see {@linkplain "https://lists.oasis-open.org/archives/xacml-dev/201507/msg00001.html"}), the
	 * XACML 3.0 core spec, §7.3.3, indicates that multiple occurrences of the same &lt;Attribute&gt; with same meta-data but different values should be considered equivalent to a single
	 * &lt;Attribute&gt; element with same meta-data and merged values (multi-valued Attribute). Moreover, the XACML 3.0 conformance test 'IIIA024' expects this behavior: the multiple subject-id
	 * Attributes are expected to result in a multi-value bag during evaluation of the &lt;AttributeDesignator&gt;.
	 * <p>
	...
	private static abstract class LaxJaxbXACMLAttributeParser implements JaxbXACMLAttributeParser<MutableAttributeBag<?>>
	{
		 ...
		 *             iff {@code datatypeFactoryRegistry == null}
		 */
		private LaxJaxbXACMLAttributeParser(final DatatypeFactoryRegistry datatypeFactoryRegistry) throws IllegalArgumentException
		{
			if (datatypeFactoryRegistry == null)
			{
				throw NULL_DATATYPE_FACTORY_REGISTRY_ARGUMENT_EXCEPTION;
	...
	public static final class IssuedToNonIssuedCopyingLaxJaxbXACMLAttributeParser extends LaxJaxbXACMLAttributeParser
	{
		 ...
		 */
		public IssuedToNonIssuedCopyingLaxJaxbXACMLAttributeParser(final DatatypeFactoryRegistry datatypeFactoryRegistry) throws IllegalArgumentException
		{
	...
	public static final class NonIssuedLikeIssuedLaxJaxbXACMLAttributeParser extends LaxJaxbXACMLAttributeParser
	{
		 ...
		 *             if {@code datatypeFactoryRegistry == null}
		 */
		public NonIssuedLikeIssuedLaxJaxbXACMLAttributeParser(final DatatypeFactoryRegistry datatypeFactoryRegistry) throws IllegalArgumentException
		{
			super(datatypeFactoryRegistry);
		}
	 ...
	 */
	private static abstract class BaseJaxbXACMLAttributesParser<BAG extends Iterable<? extends AttributeValue>> implements JaxbXACMLAttributesParser
	{
		...
		private BaseJaxbXACMLAttributesParser(final JaxbXACMLAttributeParser<BAG> jaxbAttributeParser, final NamedAttributeIteratorConverter<BAG> namedAttributeIteratorConverter)
		{
		...
		public SingleCategoryAttributes<BAG> parseAttributes(final Attributes jaxbAttributes, final XPathCompiler xPathCompiler) throws IndeterminateEvaluationException
		{
			 ...
			 */
			final Attributes attrsToIncludeInResult = returnedAttributes.isEmpty() ? null : new Attributes(null, returnedAttributes, jaxbAttributes.getCategory(), jaxbAttributes.getId());
			return new SingleCategoryAttributes<>(attrMap.entrySet(), namedAttrIterConverter, attrsToIncludeInResult, extraContent);
		}
	}

	private static final class ContentSkippingJaxbXACMLAttributesParser<BAG extends Iterable<? extends AttributeValue>> extends BaseJaxbXACMLAttributesParser<BAG>
	{
		private ContentSkippingJaxbXACMLAttributesParser(final JaxbXACMLAttributeParser<BAG> jaxbAttributeParser, final NamedAttributeIteratorConverter<BAG> namedAttributeIteratorConverter)
		{
	 ...
	 */
	public static final class ContentSkippingJaxbXACMLAttributesParserFactory<BAG extends Iterable<? extends AttributeValue>> implements JaxbXACMLAttributesParserFactory
	{
				...
				throws IllegalArgumentException
		{
			...
			instance = new ContentSkippingJaxbXACMLAttributesParser<>(jaxbAttributeParser, namedAttributeIteratorConverter);
		}
	...
	private static final class FullJaxbXACMLAttributesParser<BAG extends Iterable<? extends AttributeValue>> extends BaseJaxbXACMLAttributesParser<BAG>
	{
		...
		private FullJaxbXACMLAttributesParser(final JaxbXACMLAttributeParser<BAG> jaxbAttributeParser, final NamedAttributeIteratorConverter<BAG> namedAttributeIteratorConverter,
	 ...
	 *            resulting from parsing XACML AttributeValues
	 */
	public static final class FullJaxbXACMLAttributesParserFactory<BAG extends Iterable<? extends AttributeValue>> implements JaxbXACMLAttributesParserFactory
	{
		...
		public JaxbXACMLAttributesParser getInstance()
		{
			...
			return new FullJaxbXACMLAttributesParser<>(jaxbAttributeParser, namedAttrIterConverter, xmlProc.newDocumentBuilder());
		}
	}
