...
public interface DatatypeFactory<INSTANCE_AV extends AttributeValue> extends PdpExtension
{
	...
	/**
	 * returns true iff the expression based on this value always evaluates to the same constant in any evaluation context (not the case of xpathExpressions for
	 * instance).
	 * 
