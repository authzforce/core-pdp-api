...
public interface CombiningAlg<T extends Decidable> extends PdpExtension
{
	...
	interface Evaluator
	{
		 ...
		 * 
		 * @param context
		 *            the Individual Decision request evaluation context
		 * @param mdpContext
		 ...
		 */
		ExtendedDecision evaluate(EvaluationContext context, Optional<EvaluationContext> mdpContext, UpdatableList<PepAction> updatablePepActions, UpdatableList<PrimaryPolicyMetadata> updatableApplicablePolicyIdList);
	}
